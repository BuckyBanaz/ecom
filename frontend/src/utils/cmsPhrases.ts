...
const PHRASES: Record<string, Record<string, string>> = {
  nl: {
    ...
    "Diameter": "Diameter",
    "Number of lights": "Aantal lichtbronnen",
    "Maximum wattage": "Maximale wattage",
    "Type of fitting": "Type fitting",
    "Bulb fitting": "Fitting",
    "Connection voltage": "Aansluitspanning",
    "Includes light": "Inclusief lichtbron",
    "Warranty": "Garantie",
    "Article number": "Artikelnummer",
    "Height of foot/mounting plate": "Hoogte voet/montageplaat",
    "Base/mounting plate width in cm": "Breedte voet/montageplaat in cm",
    "Foot/mounting plate length": "Lengte voet/montageplaat",
    "Yes (not included)": "Ja (niet inbegrepen)",
    "Series": "Serie",
    
    // CMS Headers & Body Text
    "Shop the Collection": "Ontdek de Collectie",
    "Provençaalse & Landelijke Verlichting": "Provençaalse & Landelijke Verlichting",
    "Elevate Your Everyday": "Verrijk Je Dagelijks Leven",
    "Laat u inspireren door onze exclusieve collectie Provençaalse lampen. Handgemaakte details, warme messing accenten en natuurlijke materialen die uw interieur transformeren tot een sfeervol Frans landhuis.": "Laat u inspireren door onze exclusieve collectie Provençaalse lampen. Handgemaakte details, warme messing accenten en natuurlijke materialen die uw interieur transformeren tot een sfeervol Frans landhuis.",
    "Nu tijdelijk met gratis premium verzending": "Nu tijdelijk met gratis premium verzending",
    "De Warmte van de Provence": "De Warmte van de Provence",
    "Ontdek de Collectie": "Ontdek de Collectie",
    "Discover our curated collection of premium, sustainably crafted essentials designed for modern living.": "Ontdek onze zorgvuldig geselecteerde collectie van premium, duurzaam gemaakte essentials, ontworpen voor modern wonen.",
    "Breng de warme, rustieke elegantie van het Zuiden in huis": "Breng de warme, rustieke elegantie van het Zuiden in huis",
  },
};
